# AI-Powered OR Modeling Assistant: 设计思路
...
## 我们的方案：Multi-step Workflow

与其让LLM生成代码，不如让LLM生成**结构化数据**，然后由**受控的建模模板**来执行。

这就是 Multi-step Workflow 的核心思想：
...
Multi-step Workflow 不是最复杂的AI架构，但它是最**实用**、最**安全**、最**可教学**的。
